...
const Airdrop = () => {
  const {user, loading} = useMongoUser();
      ...
      const qualifications = [
        {
            ...
            totalBalance: user.tonTransactions,
            icon: '/ton.png',
            id: 1,
        },
        {
            title: "Tasks Rewards",
            totalBalance: user.taskPoints,
            icon: '/coin.webp',
            id: 2,
        },
        {
            title: "Mining Rewards",
            totalBalance: user.miningTotal,
            icon: '/earn.svg',
            id: 3,
        },
        {
            title: "Referral Rewards",
            totalBalance: user.refBonus,
            icon: '/invite.svg',
            id: 4,
        }
      ]
...
<button 
                    ...
                    >
                        ...
                        {user.selectedExchange.id === 'selectex' ? (
                            ...
                            <span className="flex items-center justify-center mt-[1px]">
                            <img src={user.selectedExchange.icon} alt={user.selectedExchange.title} className={`w-[34px] h-[34px] rounded-full`} />
                          </span>
                        )}
