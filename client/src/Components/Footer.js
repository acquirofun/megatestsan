...
},
{
  title: "Earns",
  link: "/earn",
  icon: <img id="reels3" alt='dfd' src='/earn.svg' className={location.pathname === "/earn" ? "w-[22px] h-[22px] brightness-[0.1]" : "w-[22px] h-[22px]"} />
},
  {
      title: "Friends",
      link: "/ref",
...
isActive
  ...
  `;
    ...
    >
              <span id={`reels${footer.title}`} className={location.pathname === `${footer.link}` ? 
